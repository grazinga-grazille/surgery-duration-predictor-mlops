...
# Streamlit :8501  |  FastAPI :8000  |  Postgres :5432  |  MinIO :9000/:9001
# Infra only: docker compose up -d postgres minio
```
...
│   ├── mlflow/ prefect/ nannyml/ nginx/   # placeholders
├── db/init.sql                       # Postgres schema placeholder
...
├── docker-compose.yml                # Postgres, MinIO, Streamlit, FastAPI
